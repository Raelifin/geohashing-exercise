describe("Geohash", function() {
	...
	describe('getChildValueFromLocation', function() {
		var subject = require('../lib/geohash').getChildValueFromLocation;
		it('returns a price string for Yahoo API data and location', function() {
			...
			var sampleObject = JSON.parse(sampleResponse);
			var yahooLocation = require('../lib/geohash').yahooAPIOpeningPriceLocation;
			
			var result = subject(sampleObject, yahooLocation);
